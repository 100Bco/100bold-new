  ...
  return (
    <div style={{position:'relative',width:'100%',height:'100%',minHeight:400,display:'flex',alignItems:'center',justifyContent:'center'}}>
      ...
      >
        ...
        <div>
          <div style={{width:44,height:7,background:'#d1d5db',borderRadius:4,marginBottom:5}} />
          <div style={{width:28,height:7,background:'#e5e7eb',borderRadius:4}} />
        </div>
      </motion.div>
      ...
      >
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
      </motion.div>
      ...
      <motion.div
        ...
        style={{position:'absolute',bottom:'22%',right:'8%',zIndex:20,background:'#1877F2',padding:'14px 18px',borderRadius:14,boxShadow:'0 12px 28px rgba(24,119,242,.25)',display:'flex',alignItems:'center',gap:10}}
      >
