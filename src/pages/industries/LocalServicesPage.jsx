      ...
      <section className="page-hero">
        <div className="mx">
          <div style={{display:'flex',alignItems:'center',gap:16,marginBottom:24}}>
            <LottieIcon src="/power-red.json" />
            <div>
              <h1 className="rv vis" style={{marginBottom:0}}>Local Service <span className="accent">Contractors.</span></h1>
              <p style={{fontSize:17,color:'var(--text-3)',marginTop:8}}>HVAC, Plumbing, Electrical, Roofing, Solar, Painting, Pest Control</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="mx">
          <div style={{maxWidth:800}}>
            <div className="rv" style={{background:'var(--card)',border:'1px solid var(--border)',borderRadius:24,padding:'32px 36px',marginBottom:24}}>
              ...
              <p style={{fontSize:20,color:'var(--dark)',fontWeight:600,lineHeight:1.5}}>More calls, more jobs, less marketing complexity</p>
            </div>
            <div className="rv rv-d1" style={{background:'var(--card)',border:'1px solid var(--border)',borderRadius:24,padding:'32px 36px',marginBottom:40}}>
              ...
              <p style={{fontSize:20,color:'var(--text-2)',fontStyle:'italic',lineHeight:1.6}}>"We take over your Google presence completely. More reviews, more visibility, more calls — without you touching it."</p>
            </div>
